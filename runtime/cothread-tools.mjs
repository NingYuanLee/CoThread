...
export function apply(ctx) {
  ...
  const definitions = [
    ...
    ["create_task", "创建项目任务。assist_l2 为 Ask 只读辅助：必须有空闲 L3，创建即执行中，立刻 dsh_l3；没有空闲 L3 时不要创建。目标为本 L2 的 formal 为沙箱任务：有空闲则执行中并立刻 dsh_l3，否则 pending_assignment。给人的 formal 只能指派人类成员，须本轮授权，状态待确认。可传 documentRefs（正式文件版本 ID，最多 30 个）和 folderRefs（正式文件文件夹 ID，最多 30 个）作为任务资料。不要为小祥自己就能完成的回复建任务。", {
