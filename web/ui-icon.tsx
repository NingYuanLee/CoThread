...
const GLYPHS: Record<GlyphName, string[]> = {
  ...
  globe: ["M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18Z", "M3 12h18", "M12 3c2.2 2.4 3.3 5.4 3.3 9S14.2 18.6 12 21", "M12 3C9.8 5.4 8.7 8.4 8.7 12s1.1 6.6 3.3 9"],
  ...
  smartphone: ["M7 3h10v18H7z", "M10 6h4", "M11 18h2"],
